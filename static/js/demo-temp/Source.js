...
function call_source(time_str,area_str){
    $.getJSON("static/data/Source/"+area_str+".json", function (data){
        var source_data=data[time_str];
        source(source_data,time_str);
    })
}
...
function source(source_data,time_str){
